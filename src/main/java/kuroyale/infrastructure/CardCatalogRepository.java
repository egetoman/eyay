...
public class CardCatalogRepository {
        ...
        public List<Card> findAll() {
                ...
                cards.add(troop("card_knight", "Knight", 3, 600, 75, 1.0, "Medium", 1.1, CardTarget.GROUND,
                                "A tough soldier with a sword. Good for soaking damage."));
                cards.add(troop("card_musketeer", "Musketeer", 4, 340, 100, 6.5, "Medium", 1.1,
                                CardTarget.AIR_AND_GROUND, "A ranged shooter that can hit air and ground."));
                cards.add(troop("card_mini_pekka", "Mini P.E.K.K.A", 4, 600, 325, 1.0, "Slow", 1.8, CardTarget.GROUND,
                                "A powerful armored warrior. Slow but massive damage."));
                cards.add(troop("card_giant", "Giant", 5, 2000, 126, 1.0, "Very Slow", 1.5, CardTarget.BUILDINGS,
                                "Huge tank that targets buildings only."));
                cards.add(troop("card_hog_rider", "Hog Rider", 4, 800, 160, 1.0, "Fast", 1.5, CardTarget.BUILDINGS,
                                "Fast unit that rushes toward buildings."));

                // Area-of-effect troops
                cards.add(troop("card_bomber", "Bomber", 3, 150, 100, 5.0, "Medium", 1.9, CardTarget.GROUND,
                                "Throws bombs that explode on impact."));
                cards.add(troop("card_valkyrie", "Valkyrie", 4, 880, 120, 1.0, "Medium", 1.5, CardTarget.GROUND,
                ...
                cards.add(building("card_tesla", "Tesla", 4, 400, 64, 5.5, 0, CardTarget.AIR_AND_GROUND,
                                "Hidden tower that hits air & ground."));
                cards.add(building("card_mortar", "Mortar", 4, 600, 108, 11.0, 5.0, CardTarget.GROUND,
                                "Long-range artillery."));
                cards.add(building("card_bomb_tower", "Bomb Tower", 5, 900, 100, 6.0, 1.8, CardTarget.GROUND,
                                "Defensive tower with explosive shells."));
                cards.add(building("card_inferno_tower", "Inferno Tower", 5, 800, 200, 6.0, 1.0,
                                CardTarget.AIR_AND_GROUND, "Laser tower that ramps damage."));

                // Spawner / special buildings
                cards.add(building("card_tombstone", "Tombstone", 3, 200, 0, 0, 0, CardTarget.GROUND,
                                "Spawns skeletons over time."));
                cards.add(building("card_goblin_hut", "Goblin Hut", 5, 700, 0, 0, 0, CardTarget.GROUND,
                                "Spawns spear goblins periodically."));
                cards.add(building("card_barbarian_hut", "Barbarian Hut", 7, 1100, 0, 0, 0, CardTarget.GROUND,
                                "Spawns barbarians periodically."));
                cards.add(building("card_elixir_collector", "Elixir Collector", 5, 640, 0, 0, 0, CardTarget.NONE,
        ...
        private Card building(String id, String name, int cost, int hp, int damage, double rangeTiles,
                        double hitSpeedSeconds, CardTarget target, String description) {
                return new Card(id, name, cost, CardType.BUILDING,
                                stats(hp, damage, rangeTiles, "None", hitSpeedSeconds), target, description);
        }
